...
st.markdown("""
    ...
    /* ---------- METALLIC LOGO WITH SPIN, MOTION TRAIL ---------- */
    .logo-container {
        display: flex;
    ...
    .logo-emblem {
        ...
        align-items: center;
        justify-content: center;
        animation: spinBlur 4s ease-in-out infinite;
        overflow: visible;
    ...
    .logo-emblem::after {
        ...
        height: 100%;
        border-radius: 50%;
        background: linear-gradient(135deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0) 40%, rgba(255,255,255,0.2) 60%, rgba(255,255,255,0) 100%);
        pointer-events: none;
        z-index: 5;
    ...
    .logo-text {
        ...
        -webkit-text-fill-color: transparent;
        background-clip: text;
        animation: rippleText 3s ease-in-out infinite;
    }
...
def about_content():
    ...
    # Voice button inside About section
